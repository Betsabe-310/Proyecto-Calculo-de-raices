...
<!--Menú-->
    ...
    <py-script>
            ...
            def create_html_element(i,a,c,b,fa,fb,fc, tramo):
              #Se crean las etiquetas tr= fila  y td= columna (elementos)            
              ...
              #Se asignan valores a las etiquetas td
              ...
              #Se le agregan las etiquetas td a la etiqueta tr  
            ...
            def create_form(funcion,c):
                ...
                metodo.setAttribute("value", "falsa posicion")
        ...
        <h1 class="titulo_metodo">FALSA POSICIÓN</h1>
        <div id="resp"></div>
